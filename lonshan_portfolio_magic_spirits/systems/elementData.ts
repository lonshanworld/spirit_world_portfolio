...
export const SPIRIT_DEFINITIONS: Record<ElementType, SpiritDefinition> = {
  ...
  void: {
    ...
    primaryColor: '#880033', secondaryColor: '#440018',
    glowColor: 'rgba(136,0,51,0.6)', shadowColor: 'rgba(68,0,24,0.9)',
  ...
  robot: {
    ...
    primaryColor: '#AABBCC', secondaryColor: '#778899',
    glowColor: 'rgba(170,187,204,0.5)', shadowColor: 'rgba(100,120,140,0.7)',
